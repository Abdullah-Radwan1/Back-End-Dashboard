...
const OverviewChart = ({ isDashboard = false, view }) => {
 ...
 const [totalSalesLine, totalUnitsLine] = useMemo(() => {
  ...
  const totalSalesLine: { data: any; id: string; color: string } = {
   id: "totalSales",
   color: theme.palette.secondary.main, // Secondary color for total sales line
   data: [],
  };
  const totalUnitsLine: { data: any; id: string; color: string } = {
   id: "totalUnits",
   color: theme.palette.primary.main, // Primary color for total units line
   data: [],
  };
  ...
  <ResponsiveLine
   ...
   theme={{
    axis: {
     domain: {
      line: {
       stroke: theme.palette.primary.main, // Axis line color
      },
     },
     legend: {
      text: {
       fill: theme.palette.primary.main, // Legend text color
      },
     },
     ticks: {
      line: {
      ...
      text: {
       fill: theme.palette.primary.main, // Tick text color
      },
     },
    },
    legends: {
